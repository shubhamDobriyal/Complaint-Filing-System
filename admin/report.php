...
<!---------------------------------------------------####################dsfvbl k.xnv ndhvk jvnlz ○joi vdjl##################
...
<div class="col-sm-12">
 <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
    ...
    <div class="form-group">
	 ...
	 <div class="form-group">
      <label class="control-label col-sm-2" >Accues:</label>
      <div class="col-sm-10">          
        <input type="text" readonly="" class="form-control" required=""  name="accused" style="width:100%;" value="<?php echo $accused_tmp; ?>">
      </div>
    </div>
...
<div class="form-group">
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >Investigation Report:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" required=""  name="investigation" style="width:100%;"value="<?php echo $investi_rprt_tmp; ?>">
      </div>
    </div>
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >Under Constitutional Act:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" required=""  name="act" style="width:100%;" value="<?php echo $act_tmp; ?>">
      </div>
    </div>
...
<div class="form-group">
      <label class="control-label col-sm-2" >Investigation Department/Team:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" required=""  name="inv_dpt" style="width:100%;" value="<?php echo $inv_dpt_tmp; ?>">
      </div>
    </div>
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >File No:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" required=""  name="fileNo" style="width:100%;" value="<?php echo $fileNo_tmp; ?>">
      </div>
    </div>
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >Status:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" required=""  name="status" style="width:100%;" value="<?php echo $status_tmp; ?>">
      </div>
    </div>

    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10" style="margin-left: 500px;margin-top: 50px;">
